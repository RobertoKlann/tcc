...
<table class="table table-striped">
  ...
  <tbody>
  <?php foreach($subcategorias as $oSubCategoria): ?>
        <tr>
            <td><?= $oSubCategoria->sbccodigo ?></td>
            <td><?= $oSubCategoria->sbcdescricao ?></td>
            <td><?= $oSubCategoria->ctgdescricao ?></td>
            <td>
                <a id="anchorAlterar" data-toggle="modal" data-target="#modalAlteracao" class="anchor-icons" href="#sign_up" value="{{$oSubCategoria->sbccodigo}}">
                    <i class="fas fa-edit"></i>
                </a>
                <a class="anchor-icons" href="{{action('ControllerSubCategoria@deleteSubCategoria', $oSubCategoria->sbccodigo)}}">
  ...
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalScrollableTitle">Incluir SubCategoria</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="/ViewInicial/insereSubCategoria">
...
<div class="modal fade" id="modalAlteracao" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/ViewInicial/updateSubCategoria">
          <div class="form-group">
            <label for="codigo">Código</label>
          ...
          <div class="form-group">
            <label for="descricao">Descrição</label>
            <input type="text" name="descricao" class="form-control input-descricao" id="descricao">
          </div>
          <div class="form-group">
            <select name="catcodigo" class="custom-select select-form custom-select-lg mb-3">
